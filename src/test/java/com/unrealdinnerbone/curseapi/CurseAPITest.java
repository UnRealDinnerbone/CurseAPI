...
public class CurseAPITest extends BaseTest
{
    ...
    @Test
    public void getGame() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().getGame(432));
    }


    @Test
    public void getGameVersions() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().getGameVersions(432));
    }

    @Test
    public void getCategories() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().getCategories( new Query.Category().setGameId(432)));
    }

    @Test
    public void searchMods() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().searchMods(new Query.Mod().gameId(432)));
    }


    @Test
    public void testGameVersionsTypes() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().getVersionTypes(432));
    }


    @Test
    public void getMod() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().getMod(297028));
    }

    @Test
    public void getMods() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().getMods(new ModsByIdsListRequestBody(List.of(297028))));
    }

    @Test
    public void getFeaturedMods() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().getFeaturedMods(new FeaturedModsRequestBody(432, new ArrayList<>(), Optional.empty())));
    }

    @Test
    public void getModDescription() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().getModDescription(297028));
    }


    @Test
    public void getModFile() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().getModFile(297028, 3432688));
    }

    @Test
    public void getFiles() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().getFiles(297028));
    }

    @Test
    public void getAllFiles() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().getFiles(new ModFilesRequestBody(Arrays.asList(297028))));
    }

    @Test
    public void getFileChangelog() throws ExecutionException, InterruptedException {
        test(CURSE_API.v1().getFileChangelog(297028, 3432688));
    }

    @Test
    public void getFileDownloadURl() throws ExecutionException, InterruptedException {
